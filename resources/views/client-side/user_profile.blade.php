                            ...
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="post">
                                    <div class="user-block">
                                        @if ($latest_user_post->user->image)
                                        <div class="image mr-3"> <img src="{{asset('/storage/profiles/'.$latest_user_post->user->image)}}" class="rounded-circle" width="60" /> </div>
                                        @else
                                        <div class="image mr-3"> <img src="{{asset('/storage/profiles/default.png')}}" class="rounded-circle" width="60" /> </div>
                                        @endif
                                        <span class="username">
                                ...
                                @else
                                    <p>
                                        User has not started any discussions yet.
                                    </p>
                                    @endif
                                <!-- /.post -->
                                <br />
